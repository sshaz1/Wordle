...
/**
 * Controller class for the Wordle game interface (easy mode).
 *
 * @author Emily Christina Atyeo (251281573)
 */
public class WordleGameplayControllerEasy implements WordleGameplayController{
    /** TextField for user's guess input. */
    @FXML
    ...
    /** Labels representing the boxes on the game board where the letters of the guesses are displayed. */
    @FXML
    public Label box00, box01, box02, box03, box04, box05, box06, box07, box08, box09, box10, box11, box12, box13, box14 = new Label();
    @FXML
    public Label box15, box16, box17, box18, box19, box20, box21, box22, box23, box24, box25, box26, box27, box28, box29 = new Label();

    /** Button to submit the current guess. */
    @FXML
    private Button checkButton;

    /** Button to continue after a game ends, leading to the next screen. */
    @FXML
    ...
    /** Label displaying the player's ID. */
    @FXML
    private Label playerId;

    /** Text element displaying personal best score information. */
    @FXML
    public Text pbText;

    /** Text element displaying high score information. */
    @FXML
    private Text hsText;
    ...
    /**
     * Sets the current level of the game. This level indicates the difficulty and sequence in the gameplay.
     *
    ...
    /**
     * Sets the word that the player needs to guess in the current game. This word is the answer key for the gameplay.
     *
    ...
    public void handleCheckGuess() {
        ...
        if (guess.length() != 3) {
            feedbackText.setText("Invalid guess. Please enter a 3-letter word.");
        ...
        if (numberOfGuesses == 1) {
            Label[] row1 = {box00, box01, box02};
            checkGuess(row1);
            playerScore = playerScore - 50;

        } else if (numberOfGuesses == 2) {
            Label[] row2 = {box05, box06, box07};
            checkGuess(row2);
            playerScore = playerScore - 50;

        } else if (numberOfGuesses == 3) {
            Label[] row3 = {box10, box11, box12};
            checkGuess(row3);
            playerScore = playerScore - 50;

        } else if (numberOfGuesses == 4) {
            Label[] row4 = {box15, box16, box17};
            checkGuess(row4);
            playerScore = playerScore - 50;
     ...
     */
    @FXML
    public void updateLevelHighScore(Label playerId, Label game_level, int playerScore, String pathName) {
        // Extract level and player ID from the provided labels
        int level = Integer.parseInt(game_level.getText());
        int playerIdValue = Integer.parseInt(playerId.getText());
    ...
    /**
     * Continues to the next screen after completing a game.
     *
     * @param event The mouse event triggered by clicking the continue button.
    ...
    private void onContinueButtonClicked(MouseEvent event) throws IOException {
        ...
        resultController.setPlayerScore(playerScore+50);
